...
#define SWIG_init    Init_Elemez
#define SWIG_name    "Elemez"

static VALUE mElemez;
...
extern "C"
#endif
SWIGEXPORT void Init_Elemez(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mElemez = rb_define_module("Elemez");
  ...
  rb_define_module_function(mElemez, "native_raiseDisruption", _wrap_native_raiseDisruption, -1);
}
